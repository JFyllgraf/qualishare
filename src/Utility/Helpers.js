...
export function getDefaultText(){
  const htmlString =
    `WASHINGTON — The Trump administration is pushing the U.N. Security Council to call attention to the Chinese origins of the coronavirus, four diplomats posted to the United Nations told NBC News, triggering a stalemate as the global body seeks to cobble together a response to the pandemic.<br><br> Talks among U.N. Security Council nations over a joint declaration or resolution on the coronavirus have stalled over U.S. insistence that it explicitly state that the virus originated in Wuhan, China, as well as exactly when it started there. <span user="Sofie" id="5eaec6cc01c6bc38a80a9fbc" onClick="removeSPan(this)" style="background-color: rgb(92, 78, 201);">China's diplomats are enraged according to the diplomats, even as they seek to put their own language into the statement praising China's efforts to contain the virus.</span><br><br> The dispute at the United Nations comes amid growing finger-pointing between Washington and Beijing over the coronavirus.<br><br>

    <span user="Morten" id="5eaec70b01c6bc38a80a9fbd" onClick="removeSPan(this)" style="background-color: rgb(38, 239, 95);"> President Donald Trump has repeatedly blamed China for its spread, accusing Beijing of concealing early knowledge of the virus.</span> But after reports of a rise in racism and attacks against Asian Americans emerged, Trump tweeted this week that it was "NOT their fault" and said he'd no longer call it the "Chinese virus." <br><br>

    "Everyone knows it came out of China," Trump said Tuesday. <span user="Morten" id="5eaec6b101c6bc38a80a9fba" onClick="removeSPan(this)" style="background-color: rgb(50, 168, 82);">"But I decided we shouldn't make any more of a big deal out of it."</span><br><br>
